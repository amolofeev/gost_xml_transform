...
25. Атрибуты должны быть отсортированы в алфавитном порядке:
    ...
    затем – по local name. Атрибуты в unqualified form после сортировки идут после атрибутов в qualified form.
...
class XMLTest(TestCase):
    ...
    def test_qualified_attribute_sorting_with_different_namespace(self):
        logging.warning(
            ...
            "I've implemented sorting like order by uri, name as described in p.25"
        )
        self.assertEqual(
            '<ns1:tag xmlns:ns1="urn://1" xmlns:ns2="urn://2" xmlns:ns3="urn://3" xmlns:ns4="urn://4" '
            'ns2:b="1" ns3:c="1" ns4:a="1"></ns1:tag>',
            GOSTXMLTransform.from_string(
                '<m1:tag xmlns:m4="urn://4" xmlns:m3="urn://3" xmlns:m2="urn://2" xmlns:m1="urn://1" '
                'm3:c="1" m2:b="1" m4:a="1"/>'
            ).to_bytes().decode('utf-8')
        )
    ...
    def test_qualified_attribute_sorting_with_different_namespace_and_names(self):
        ...
        self.assertEqual(
            '<ns1:tag xmlns:ns1="urn://1" xmlns:ns2="urn://2" xmlns:ns3="urn://3" xmlns:ns4="urn://4" '
            'ns2:a="1" ns2:b="1" ns2:c="1" '
            'ns3:a="1" ns3:b="1" ns3:c="1" '
